...
if __name__  == '__main__':
    ...
    #explain_gradcam(image_path='./case_studies/0/11979.jpg',model=model,device=device)
    explain_rise(image_path='./case_studies/0/1197.jpg',model=model,N=100,device=device,fit_callback=fit_callback,exp_callback=explain_callback)
